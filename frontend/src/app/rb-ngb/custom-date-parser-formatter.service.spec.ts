...
describe('FrenchDateParserFormatterService', () => {
  ...
  describe('parsing', () => {
    test('should parse null undefined and empty string as null', () => {
    ...
    test('should parse non-date as null', () => {
    ...
    test('should do its best parsing incomplete dates', () => {
      expect(pf.parse('5/2011')).toEqual({ year: 2011, month: 5, day: null as unknown as number });
    });
  });

  describe('formatting', () => {
    test('should format null and undefined as an empty string', () => {
    ...
    test('should format a valid date with padding', () => {
      expect(pf.format({ year: 2016, month: 2, day: 5 })).toBe('05/02/2016');
    });

    test('should try its best with invalid dates', () => {
